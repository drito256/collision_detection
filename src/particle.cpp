...
void Particle::update(float dt){
    ...
    this->model_matrix = glm::rotate(this->model_matrix, angle, glm::normalize(/*glm::vec3(q.x,q.y,q.z) + */initial_rotation));
    this->model_matrix[3] = translation; // translation component
}
